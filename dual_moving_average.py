...
def analyze(context, perf):
    ...
    # Second chart: Plot asset price and buys/sells
    ...
    perf.loc[:, ['price_change', 'algorithm_period_return']].plot(ax=ax3)
    ax3.legend_.remove()
...
if __name__ == '__main__':
    ...
    run_algorithm(
            ...
            end=pd.to_datetime('2020-1-30', utc=True),
        )
